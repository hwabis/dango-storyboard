...
{
    public class Everything : StoryboardObjectGenerator
    {
        ...
        public override void Generate()
        {
            ...
            bg06.Move(end05 - beatLength, end06,
                bg06.PositionAt(end05 - beatLength) + new CommandPosition(-30, 0),
                bg06.PositionAt(end05 - beatLength) + new CommandPosition(60, 0));
            ...
            white.Fade(65013 - beatLength * 4, 65013, 0, 0.8);
            white.Fade(65013, 65013 + beatLength * 2, 0.8, 0);

            double end04 = 97372;
            bg04.Fade(end07 - beatLength / 2, end07 + beatLength / 2, 0, 1);
            bg04.Fade(end04 - beatLength, end04, 1, 0);
            bg04.Scale(end07 - beatLength / 2, end04, bg04.ScaleAt(0).X, bg04.ScaleAt(0).X + 0.06);

            double end08 = 108159;
            bg08.Fade(end04 - beatLength, end04, 0, 1);
            bg08.Fade(end04, end08 - beatLength * 2, 1, 0.75);
            bg08.Fade(end08 - beatLength * 2, end08, 0.75, 0);
            bg08.Rotate(end04 - beatLength, end08, 0, -0.1);
            bg08.Scale(end04 - beatLength, end08, 0.5, 0.45);

            bgFinal.Fade(end08 - beatLength * 4, end08 - beatLength, 0, 0.9);
